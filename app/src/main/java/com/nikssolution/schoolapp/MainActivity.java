package com.nikssolution.schoolapp;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.dashboard) {
           ...
           // startActivity(intent);
            ...
            Intent intent= new Intent(MainActivity.this, MyLeaves.class);
            startActivity(intent);
        } else if (id == R.id.transport) {
            Intent intent= new Intent(MainActivity.this, TransportSection.class);
            startActivity(intent);
            ...
            Intent intent= new Intent(MainActivity.this, Circular.class);
            startActivity(intent);
